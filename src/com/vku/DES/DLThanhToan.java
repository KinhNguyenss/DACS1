...
public class DLThanhToan extends javax.swing.JDialog {
    ...
    int tong, MaHD;
    int MaBan;
    public DLThanhToan(boolean modal, int tongtien, String tenban, int maban, int mahd) {
        initComponents();
        tong = tongtien;
        MaHD = mahd;
        MaBan = maban;
    ...
    JOptionPane.showMessageDialog(rootPane, "không đủ tiền", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
}
